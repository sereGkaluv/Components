...
public abstract class DataEnrichmentFilter<in, out>  extends AbstractFilter<in, out> implements Runnable {
    ...
    /**
     * read an indsys.entity from the thirdparty.indsys.components.filter. the thirdparty.indsys.components.filter will act like an passive-thirdparty.indsys.components.filter
     */
    ...
    /**
     * write an indsys.entity into the thirdparty.indsys.components.filter. the thirdparty.indsys.components.filter will act like an passive-thirdparty.indsys.components.filter
     * and passes the indsys.entity to the next thirdparty.indsys.components.filter, after it processed it
     * @param value
    ...
    /**
     * runs the thirdparty.indsys.components.filter in active-mode
     */
    public void run() {
